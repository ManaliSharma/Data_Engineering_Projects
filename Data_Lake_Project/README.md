...
*To run this project in local mode*, create a file `dwl.cfg` in the root of this project with the following data:
...
Create an S3 Bucket named `BUCKET_NAME where output results will be stored.
...
- dwl.cfg:  you need to create this file yourself* File with AWS credentials.
